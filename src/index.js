$(document).ready(function () {
    ...
    firebase.auth().onAuthStateChanged(userAuth => {
        if (userAuth) {
            ...
            $('#sign-in-button').on('click touchstart', (e) => {
                ...
                $('#sign-in-button').off('click touchstart');
            });
        }
    });
    ...
    $('#add-sbmt').on('click touchstart', function (e) {
        e.preventDefault();
    ...
    $('#ship-sbmt').on('click touchstart', function (e) {
        e.preventDefault();
    ...
    $(document).on('click touchstart', '#check-sbmt', function (e) {
        e.preventDefault();
    ...
    $(document).on('click touchstart', '#submit-new-count', function (e) {
        e.preventDefault();
    ...
    $(document).on('click touchstart touchstart', '.table-row', function () {
        $('#existing-items-array').empty();
    ...
    $(document).on('click touchstart', '.td-closer', function () {
        $('.tooltipped').tooltip('destroy');
        $('.temp-td').remove();
    ...
    $(document).on('click touchstart', '.review-btn', function () {
        let id = $('.showing-buttons').children().eq(1).attr('id');
        let color = $('#color-selector').val();
    ...
    $(document).on('click touchstart', '.delete-notification', function () {
    ...
    $(document).on('click touchstart', '#log-out', () => {
